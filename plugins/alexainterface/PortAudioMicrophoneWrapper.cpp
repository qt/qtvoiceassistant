...
static const std::string ALEXA_INTERFACE_CONFIG_ROOT_KEY("sampleApp");
...
bool PortAudioMicrophoneWrapper::getConfigSuggestedLatency(PaTime& suggestedLatency) {
    ...
    auto config = avsCommon::utils::configuration::ConfigurationNode::getRoot()[ALEXA_INTERFACE_CONFIG_ROOT_KEY]
